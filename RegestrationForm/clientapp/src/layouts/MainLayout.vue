            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  <div class="text-bold items-center">9844972993</div>
                  <div>Manish Pokhrel</div>
                </div>
              </div>
              ...
              <div class="column items-center">
                ...
                <q-btn
                  ...
                  v-close-popup
                >
                  <q-tooltip>Data Fetching...</q-tooltip>
                </q-btn>
              </div>
            </div>
          </q-menu>
      ...
      <q-scroll-area class="fit">
        <q-list>
          <q-item style="height: 50px" class="bg-white text-bold">
            <q-item-section> Quasar Framework Web Application </q-item-section>
          </q-item>
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              ...
              <div class="text-weight-bold">9844972993</div>
              <div>Area Group Nepal</div>
            </div>
          </q-item>
          <q-item-label header class="text-grey-8"> COLLEGE DETAILS </q-item-label>
          <q-item clickable active-class="active" exact v-ripple to="/">
            <q-item-section avatar>
                 <!-- icon-add from (materiadesignicon) -->
              <q-icon name="table_chart" />
            </q-item-section>
            <q-item-section> Student Details </q-item-section>
          </q-item>

          <q-item clickable active-class="active" exact v-ripple to="/addstudentdetails">
            <q-item-section avatar>
                <!-- icon-add from (materiadesignicon) -->
              <q-icon name="add_circle" />
            </q-item-section>
            <q-item-section> Add New Student </q-item-section>
          </q-item>
